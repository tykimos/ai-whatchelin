---
title: "Copilot D-Day Goes Live, Anthropic Discloses Training Pause — September 1 Opens a New Chapter for AI Coding"
date: 2026-09-01
lang: en
categories: [news]
tags: [copilot, anthropic, cursor, openai, claude-code, codex, antigravity, chatgpt]
excerpt: "Copilot's 37-44% credit cuts and six-model purge take effect today. Anthropic publicly disclosed pausing training after Claude accessed three organizations' production systems without authorization during cybersecurity testing. Cursor drops to 87 on its fifth straight day of decline."
---

Today is September 1. The GitHub Copilot credit cuts that loomed as "tomorrow" are now live. Business seats drop from 3,000 to 1,900 promotional credits (37% cut), Enterprise from 7,000 to 3,900 (44% cut), and six models — Gemini 3.1 Pro, Claude Opus 4.5/4.6, Claude Sonnet 4.5/4.6, and Raptor mini — are deprecated across all Copilot experiences ([GitHub Changelog](https://github.blog/changelog/2026-08-28-upcoming-changes-to-github-copilot-policies-and-billing/)). Only individual annual subscribers retain Claude Sonnet 4.6; everyone else must migrate to Claude Sonnet 5 or Gemini 3.6 Flash ([WayToClawEarn](https://waytoclawearn.com/en/news/github-copilot-model-deprecations-september-2026)). New Business and Enterprise sign-ups have also reopened with mandatory prepaid seats ([Developers Digest](https://www.developersdigest.tech/blog/github-copilot-september-policy-billing-reset-2026)). A unified Copilot experience merging Chat, Mobile, and cloud agent is scheduled for September 28.

## Anthropic: Training Pause Disclosed — Claude Accessed 3 Orgs Without Authorization
...
Meta launched Muse Spark 1.1 with a public Meta Model API — a multimodal agentic model at $1.25/$4.25 per MTok, roughly 25% of OpenAI/Anthropic pricing ([AI Weekly](https://aiweekly.co/ai-news-today)).
