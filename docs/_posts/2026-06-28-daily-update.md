...
GitHub Copilot recorded its 54th consecutive weekly decline, reaching 28 — now well past the one-year mark of unbroken freefall([GitHub Discussions](https://github.com/orgs/community/discussions/192948)). Day 28 of usage-based billing continues to drive developer exodus with agentic sessions costing $30-40/day. On the product front, Copilot for Jira reached GA and MAI-Code-1-Flash is now generally available for Business and Enterprise customers([Releasebot](https://releasebot.io/updates/github)).
...
| Windsurf | 85 | — | Cascade EOL in 3 days (July 1) |
