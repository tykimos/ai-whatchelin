---
title: "o3 Exits ChatGPT Today — Four Model Retirements in One Week Mark AI Coding's Biggest Turnover Event"
date: 2026-08-26
lang: en
categories: [news]
tags: [openai, o3, chatgpt, claude-code, anthropic, ipo, codex-cli, cursor, copilot, grok-build]
excerpt: "OpenAI o3 officially retired from ChatGPT today. With DALL-E GPT (8/30), GPT-5.4 (8/31), and Copilot's 6-model deprecation (9/1) still ahead, the most concentrated model turnover week in AI coding history has begun."
---

OpenAI o3 officially retired from ChatGPT today, August 26, concluding the 90-day sunset period that began May 28. With four model retirements cascading through the rest of the week, this is the most concentrated model turnover event in AI coding tool history.

## OpenAI: o3 Retires Today — The GPT-5.6 Era Is Official
...
| Tool | Score | Δ | Signal |
|---|---|---|---|
| Claude Code | 99 | — | v2.1.245, /design skill, 30-week streak at 99 |
| ChatGPT | 99 | — | o3 retired today, full GPT-5.6 transition |
| Codex CLI | 99 | — | codex doctor shipped, 20M users |
| Antigravity | 99 | — | Enterprise VS Code extension |
| Claude AI | 99 | — | S-1 imminent, $2T IPO countdown |
| Cursor | 99 | — | Origin beta, SpaceX acquisition closed |
| Windsurf | 86 | — | Devin Desktop stabilizing |
| Aider | 68 | — | No release since May |
| Copilot | 1 | — | 106-week decline, Sep 1 mass deprecation D-6 |
| Gemini CLI | 1 | — | Shutdown day 69 |

The o3 retirement is more than a model swap. It marks OpenAI's strategic consolidation of its entire reasoning lineup under the GPT-5 architecture, and this week's cascade of retirements is forcing migration pressure across the entire AI coding ecosystem.
