...
Apple announced Claude Agent and OpenAI Codex as agentic coding tools in Xcode at WWDC 2026([TechCrunch](https://techcrunch.com/2026/06/08/wwdc-2026-everything-announced-on-siri-ai-os-27-apple-intelligence-and-more/)). iOS and macOS developers will be able to use AI agents directly inside Xcode for the first time. Simultaneously, Siri is being rebuilt on Google's 1.2T-parameter Gemini model under a reported $1B/year deal([Qz](https://qz.com/apple-siri-ai-google-gemini-wwdc-2026-060826)). iOS 27 and macOS 27 "Golden Gate" were also unveiled.

This was also Tim Cook's final WWDC keynote — he steps down as CEO on September 1, with hardware SVP John Ternus taking the reins([Fox Business](https://www.foxbusiness.com/live-news/apple-tim-cook-wwdc26-keynote-iphone-ai-tech-june-8)). iOS 27 introduces an Extensions system that lets users choose Claude, Gemini, or ChatGPT as their default AI assistant, with a dedicated Extensions section coming to the App Store([CNBC](https://www.cnbc.com/2026/06/08/apple-wwdc-2026-live-updates.html)). However, Siri AI will not be available in the EU or China due to regulatory challenges([Qz](https://qz.com/apple-siri-ai-google-gemini-wwdc-2026-060826)). Apple also tweaked its controversial Liquid Glass design with a transparency slider and improved readability([TechCrunch](https://techcrunch.com/2026/06/08/apple-is-tweaking-its-controversial-liquid-glass-design/)).
