---
title: "GPT-5.6 삼형제 등장했는데 미 정부만 쓸 수 있다 — AI 모델 통제의 새 시대"
date: 2026-06-28
lang: ko
categories: [news]
...
GPT-4.5가 6월 27일 ChatGPT에서 공식 은퇴했다([OpenAI Help](https://help.openai.com/en/articles/6825453-chatgpt-release-notes)). 2월 출시 후 불과 4개월 만이다. 기존 대화는 GPT-5.5로 자동 이관되며, 이로써 ChatGPT에서 GPT-4 계열 모델이 완전히 사라졌다. 6월 12일 GPT-5.2 은퇴에 이어, OpenAI는 GPT-5.5 패밀리로의 통합을 가속화하고 있다.

## Fable 5 차단 16일째 — Axios "이번 주 내 복원 가능" 보도

Fable 5 수출통제가 16일째 이어지고 있지만 복원 신호가 나타났다. Axios는 6월 27일 트럼프 행정부가 Fable 5 복원에 "가까워졌다"며 "이르면 이번 주" 제한이 해제될 수 있다고 보도했다([Axios](https://www.axios.com/2026/06/27/anthropic-fable-5-return-soon)). Mythos 5는 Annex A 엔터티(승인된 미국 기관)에 한해 부분 복원됐으나 Fable은 변동 없다([explainx.ai](https://explainx.ai/blog/is-fable-5-back-2026)). 한편 중국 Zhipu AI의 GLM-5.2가 보안 벤치마크에서 Mythos급 성능을 주장하며, 수출통제의 봉쇄 논리 자체가 흔들리고 있다([explainx.ai](https://explainx.ai/blog/when-will-fable-5-be-available-again-2026)).

## Codex 12시간 장애 — 남용 방지 시스템 오작동
...
| 도구 | 점수 | 변동 | 시그널 |
|---|---|---|---|
| Claude Code | 99 | — | v2.1.195 마우스 컨트롤·음성 수정 |
| ChatGPT | 97 | ↑1 | GPT-5.6 프리뷰 열풍, GPT-4.5 은퇴 |
| Claude AI | 96 | — | Fable 5 D16, Axios 복원 신호 |
| Cursor | 96 | — | SpaceX $600억 인수 Q3 마감 대기 |
| Codex CLI | 88 | ↑1 | GPT-5.6 프리뷰 기관에 Codex 통해 제공 |
| Antigravity | 86 | ↑2 | v2.2.1, 10주 연속 상승 |
| Windsurf | 85 | — | Cascade EOL 3일 남음 (7/1) |
| Aider | 68 | — | 오픈소스 안정, v0.86.2 유지 |
| Gemini CLI | 32 | ↓4 | 셧다운 11일째, 바닥권 접근 |
| Copilot | 28 | ↓2 | 54주 연속 하락, 종량제 28일차 |
